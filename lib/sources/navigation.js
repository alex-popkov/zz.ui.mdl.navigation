...
goog.require( 'zz.views.BaseView' );
 ...
 * @extends {zz.views.BaseView}
 * @constructor
 */
zz.ui.mdl.Navigation = function( opt_title, opt_domHelper ){

	zz.views.BaseView.call( this, opt_domHelper );
...
goog.inherits( zz.ui.mdl.Navigation, zz.views.BaseView );
...
/**
 * Return header element size.
 * @returns {goog.math.Size}
 */
zz.ui.mdl.Navigation.prototype.getHeaderSize = function( ){

	return goog.style.getSize( this.headerElement_ );
};